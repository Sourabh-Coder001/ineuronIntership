...
const UpdateProduct = () => {
  ...
  const handleUpdate=async(e)=>{
    ...
    try{
      ...
      const {data}=axios.put(`http://localhost:8080/api/updateproduct/${id}`,productData)
      if(data?.success){
...
try{
  ...
  if(!answer) return;
  const {data} =await axios.delete(`http://localhost:8080/api/deleteproduct/${id}`)
    ...
    <div className="row">
        ...
        <div className="m-1 w-75">
          ...
          <div className="mb-3">
            ...
            <div className="text-center">
                <img src={`http://localhost:8080/api/productphoto/${id}`} alt="product_photo"  height={'200px '} className='img img-responsive'/>
              </div>
              )}
